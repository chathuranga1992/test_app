...
public class EncryptionKeyGenerator {
  ...
  public static final String KEY_ALIAS = "KEY_ALIAS_AIR_BRAND";
  private static final String KEY_STORE_FILE_NAME = "KEY_STORE_AIR_BRAND";
  private static final String KEY_STORE_PASSWORD = "AIR_BRAND_PASSWORD";
  ...
  static SecurityKey generateSecretKeyPre18(Context context) {
    ...
    try {
      ...
      L.d("","Secret Key Fetched :" + new String(pkEntry.getSecretKey().getEncoded(), "UTF-8"));
  ...
  private static void saveMyKeystore(Context context, KeyStore androidCAStore, char[] password,
    ...
    L.d("","Secret Key Saved : " + new String(mySecretKey.getEncoded(), "UTF-8"));
  }
}
